    ...
    <div class="card col-sm-11 p-3">
      <div id="DIV_Atender_Solicitud_de_Evento" runat="server">
        ...
        <div align="center" style="display:flex;">
          ...
          <asp:Button ID="btnBuscarEventoOrganizadoXFechaYTipo" runat="server" Text="BUSCAR" Width="200px" OnClick="btnBuscarEventoOrganizadoXFechaYTipo_Click" class="btn btn-secondary" style="margin-left: 50px;" />
        </div>
