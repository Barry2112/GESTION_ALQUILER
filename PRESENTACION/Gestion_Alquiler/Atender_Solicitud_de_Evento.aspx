    ...
    <div class="card col-sm-11 p-3">
      <div id="DIV_Atender_Solicitud_de_Evento" runat="server">
        ...
        <div align="center" class="p">
          <p>Debe de seleccionar un tipo de filtro</p>
        </div>
        <br />
        <div id="div_Filtros_Atender_Solicitud_Evento" style="text-align: center">
          ...
          <asp:Button ID="btn_Filtrar_Tipo_Evento" runat="server" Text="FILTRAR POR TIPO DE EVENTO" OnClick="btn_Filtrar_Tipo_Evento_Click" class="btn btn-secondary btn_Filtrar_Tipo_Evento" />
        </div>
        <br />
